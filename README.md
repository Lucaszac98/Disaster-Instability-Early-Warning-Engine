...
2. **Inputting Data:**
   - Use the “Data Input” tab to enter relevant information such as geographic location, hazard type, and risk factors.
   - Click “Submit” to analyze the data.
...
4. **Using Simulation Tools:**
   - Navigate to the “Simulation” tab to explore potential disaster scenarios.
   - Adjust parameters as needed and observe how changes impact risk levels.

5. **Setting Alerts:**
   - Access the “Alerts” section to set up notifications based on specific thresholds you define.
